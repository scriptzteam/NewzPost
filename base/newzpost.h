...
#ifndef __NEWZPOST_H__
#define __NEWZPOST_H__
...
#define NEWZPOSTURL "http://github.com/PietjeBell88/newzpost"
#define NEWZPOSTNAME "newzpost"
#define USER_AGENT NEWZPOSTNAME "/" VERSION " (" NEWZPOSTURL ")"
...
int newzpost(newspost_data *data, SList *file_list);

#endif /* __NEWZPOST_H__ */
